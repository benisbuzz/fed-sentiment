...
input_file_path = "data/scraping/press_conferences/pdf/"
output_file_path = "data/scraping/press_conferences/csv/"


def download_meeting_press_conference():
    with open("data/scraping/press_conferences/press_conference_dates.txt", "r") as file:
    ...
    for index, date in enumerate(dates):
        if not index % 5:
            print(index)
        try:
            file_name = 'data/scraping/press_conferences/pdf/' + date + ".pdf"
            print(file_name)
